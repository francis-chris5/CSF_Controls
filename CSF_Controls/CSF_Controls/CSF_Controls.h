...
namespace Sensors{
	...
	class Pot: public ControlUnit{
		...
		protected:
			...
			int minValueInt;	///< String to hold the mapped data from the sensor
			int maxValueInt;	///< String to hold the mapped data from the sensor
			float minValueFloat;	///< String to hold the mapped data from the sensor
			float maxValueFloat;	///< String to hold the mapped data from the sensor
	};
